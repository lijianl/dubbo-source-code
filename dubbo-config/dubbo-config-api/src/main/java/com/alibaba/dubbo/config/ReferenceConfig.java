...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    private void init() {
        ...
        // 检测 consumer 变量是否为空，为空则创建<!--<dubbo:consumer-->
        checkDefault();
        ...
        if (isJvmRefer) {
            ...
            if (urls.size() == 1) {
                ...
                if (registryURL != null) {
                    ...
                    // cluster=> Dubboinvokers => NettyConnection
